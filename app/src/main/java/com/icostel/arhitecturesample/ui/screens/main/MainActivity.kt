package com.icostel.arhitecturesample.ui.screens.main
...
import com.icostel.arhitecturesample.ui.screens.BackFragment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bottomNavigationView?.setOnNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                ...
                R.id.menu_account -> viewPager?.currentItem = ABOUT
            }
            true
        }
        hideTitle()
